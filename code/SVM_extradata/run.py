...
imagData = []
labelData = []
train_loader, validation_loader, training_batches, validation_batches = load_data('/workspace/statProject/Data/RawData_extra/train', '/workspace/statProject/Data/RawData_extra/validation', 1, get_transforms())
